...
public class Task implements Serializable {
  ...
  public boolean equals(final Object o) {
    ...
    return Objects.equals(id, task.id) && Objects.equals(title, task.title) && Objects.equals(assignedTo, task.assignedTo) && taskState == task.taskState && Objects.equals(previousState, task.previousState) && Objects.equals(taskResponse, task.taskResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, assignedTo, taskState, previousState, taskResponse);
  }
}
